 ...
 */
@ExtensionPoint(
  id = "TransAfterOpenExtensionPoint",
  extensionPointId = "TransAfterOpen",
  description = "Save named connections in the connected meta store"
)
public final class TransAfterOpenExtensionPoint extends MetaAfterOpenExtensionPoint {
  public TransAfterOpenExtensionPoint( MetastoreLocator metastoreLocator ) {
